...
sensor_data = " "
url_video = 'http://192.168.43.1:8080/video?.mjpeg'
...
class VideoStreamHandler(SocketServer.StreamRequestHandler):
    ...
    def __init__(self):
        stream = urllib.urlopen(url_video)
    print("Here")
    stream = urllib.urlopen(url_video)
    # h1: stop sign
    h1 = 15.5 - 10  # cm
        ...
        try:
            ...
            while True:
                ...
                if first != -1 and last != -1:
                    ...
                    half_image = imutils.rotate(image, -90)[120:240, :]
                    #half_image = image[120:240, :]
...
class ThreadServer(object):
    ...
    #distance_thread = threading.Thread(target=server_thread2, args=('192.168.43.1', 8002))
    #distance_thread.start()
    #video_thread = threading.Thread(target=server_thread('192.168.43.1', 8000))
    #video_thread.start()
